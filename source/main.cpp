...
//// Function that creates debris that fall on the conveyor belt, to be called at each dt
//
//void create_debris_random(double dt, double particles_second,
//    ChSystem& mysystem,
//    ChIrrApp* irr_application)
//{
//
...
//    const ChCoordsys<>& drum_csys, // pos and rotation of drum 
...
//    {
//        std::shared_ptr<ChBody> abody = (*msystem->Get_bodylist())[i];
//
//        ChVector<> diam;
//        double sigma = 0;
//        ElectricParticleProperty::shape_type shape;
//
...
//            if (typeid(myasset) == typeid(ElectricParticleProperty))
//            {
//                std::shared_ptr<ElectricParticleProperty> electricproperties = std::dynamic_pointer_cast<ElectricParticleProperty>(myasset);
//                diam = electricproperties->Cdim;
//                sigma = electricproperties->conductivity;
//                shape = electricproperties->GetShapeType();
//            }
//        }
//
...
//        ChVector<> pos = drum_csys.TransformParentToLocal(abody->GetPos());
...
//    threshold.open("output\\threshold.dat", std::ios::app);
//
//
//    /*char padnumber[100];
//    char filename[200];
...
//    mfence1->GetBody()->SetMaterialSurface(mmaterial);
...
//    mfence2->GetBody()->SetMaterialSurface(mmaterial);
...
//    mfence3->GetBody()->SetMaterialSurface(mmaterial);
...
//    mfence4->GetBody()->SetMaterialSurface(mmaterial);
//
...
//    mfence5->GetBody()->SetMaterialSurface(mmaterial);
//
...
//    mfence6->GetBody()->SetMaterialSurface(mmaterial);
//
...
//    mfence7->GetBody()->SetMaterialSurface(mmaterial);
//
...
//    mfence8->GetBody()->SetMaterialSurface(mmaterial);
//
//    if (n == 2)
//    {
...
//        mfence9->GetBody()->SetMaterialSurface(mmaterial);
//
//    }
//    if (n == 3)
//    {
...
//        ChBodySceneNode* mfence9 = static_cast<ChBodySceneNode*>(addChBodySceneNode_easyBox(
//            &mphysicalSystem, application.GetSceneManager(), 1.0,
//            ChVector<>(conveyor_length / 2 + x_splitter1, y_posbin + splitter_height / 2 - drumdiameter / 2, 0),
//            ChQuaternion<>(0, 0, 1, 0),
//            ChVector<>(splitter_width, splitter_height, bin_width)));
//        mfence9->GetBody()->SetBodyFixed(true);
//        mfence9->GetBody()->SetMaterialSurface(mmaterial);
//        ChBodySceneNode* mfence10 = static_cast<ChBodySceneNode*>(addChBodySceneNode_easyBox(
//            &mphysicalSystem, application.GetSceneManager(), 1.0,
//            ChVector<>(conveyor_length / 2 + x_splitter2, y_posbin + splitter_height / 2 - drumdiameter / 2, 0),
//            ChQuaternion<>(0, 0, 1, 0),
//            ChVector<>(splitter_width, splitter_height, bin_width)));
//        mfence10->GetBody()->SetBodyFixed(true);
//        mfence10->GetBody()->SetMaterialSurface(mmaterial);
//
//    }
//    if (n == 4)
//    {
...
//        mfence10->GetBody()->SetBodyFixed(true);
//        mfence10->GetBody()->SetMaterialSurface(mmaterial);
//        ChBodySceneNode* mfence11 = static_cast<ChBodySceneNode*>(addChBodySceneNode_easyBox(
//            &mphysicalSystem, application.GetSceneManager(), 1.0,
//            ChVector<>(conveyor_length / 2 + x_splitter3, y_posbin + splitter_height / 2 - drumdiameter / 2, 0),
//            ChQuaternion<>(0, 0, 1, 0),
//            ChVector<>(splitter_width, splitter_height, bin_width)));
//        mfence11->GetBody()->SetBodyFixed(true);
//        mfence11->GetBody()->SetMaterialSurface(mmaterial);
//    }
//
...
//    mfence12->GetBody()->SetMaterialSurface(mmaterial);
//
...
//    mfence13->GetBody()->SetMaterialSurface(mmaterial);
//
...
//    mfence14->GetBody()->SetMaterialSurface(mmaterial);
//
...
//    mfence15->GetBody()->SetMaterialSurface(mmaterial);
//
//
//    /*
...
//
//
//    auto mconveyor = std::make_shared<ChConveyor>(conveyor_length, conv_thick, conveyor_width);
//    mconveyor->SetBodyFixed(true);
//    mconveyor->SetMaterialSurface(mmaterial);
//    mconveyor->SetConveyorSpeed(STATIC_speed);
//    mconveyor->SetPos(ChVector<>(0, 0, 0));
//
//    //TODO: I suppose that also the truss has to have some collision family... check it, please!
//    mphysicalSystem.Add(mconveyor);
//    mconveyor->GetPlate()->GetCollisionModel()->SetFamily(2);
...
//    mconveyor->GetTruss()->GetCollisionModel()->SetFamily(2);
//    mconveyor->GetTruss()->GetCollisionModel()->SetFamilyMaskNoCollisionWithFamily(1);
//    mconveyor->GetTruss()->GetCollisionModel()->SetFamilyMaskNoCollisionWithFamily(3);
//
//    double drumradius = 0.15;
//    ChBodySceneNode* mDrum = static_cast<ChBodySceneNode*>(addChBodySceneNode_easyCylinder(
...
//    mDrum->GetBody()->SetMaterialSurface(mmaterial);
...
//    std::ofstream record;
//    record.open("output\\threshold.dat", std::ios::trunc);
//    record << "Time" << "\t";
//    record << "X Position" << "\t";
//    record << "Y Position" << "\t";
//    record << "Z Position" << "\t";
...
//            create_debris_particlescan(application.GetTimestep(), STATIC_flow, *application.GetSystem(), &application);
//
...
//                {
//                    std::shared_ptr<ChBody> abody = (*mphysicalSystem.Get_bodylist())[i];
//
